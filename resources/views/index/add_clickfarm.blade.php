                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" data-toggle="validator" role="form" method="POST" action="{{ url('addclickfarm') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <label class="radio-inline">
                                        <input type="radio" value="0" name="is_specified" v-model="is_specified" checked required> 否
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" value="1" name="is_specified" v-model="is_specified" required> 是
                                    </label>
                                    <p class="help-block with-errors"></p>
                                </div>
                            </div>
